...
#img = cv2.imread("targetImage.jpg")
#img_object = cv2.imread("sa.jpg", cv2.IMREAD_GRAYSCALE)
...
matching_result = cv2.drawMatches(img, kp1, img_object, kp2, matches[:count], None, flags=cv2.DRAW_MATCHES_FLAGS_NOT_DRAW_SINGLE_POINTS)
